        ...
        return this.each(function () {
            ...
            if(!options.styleOverride) {
              btnPlus.css({
                  'float': 'right',
                  'border': '0px',
                  'background-image': 'url("https://yogabody.bio/wp-content/plugins/yogabody/public/img/add.png")',
            ...
            function loadMinus(recordset) {
                ...
                if(!options.styleOverride) {
                  btnMinus.css({
                      'float': 'right',
                      'border': '0px',
                      'background-image': 'url("https://yogabody.bio/wp-content/plugins/yogabody/public/img/remove.png")',
                      'background-position': 'center center',
                      'background-repeat': 'no-repeat',
                      'height': '25px',
                      'width': '25px',
