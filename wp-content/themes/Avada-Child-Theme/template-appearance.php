								...
								<div class="section section--medium profile">
									...
									<div class="section__inner">
										<div id="setting-page-options" class="setting">
											...
											<label class="active-input" for="setting-page-title"><input class="field is-empty" data-settings-setting-key="account[page_title]" data-settings-setting-value="" data-settings-setting="data-settings-setting" id="setting-page-title" name="account[page_title]" placeholder="<?= $current_user->display_name ?>" type="text" value="<?php echo ((isset($current_user->display_name) && $current_user->display_name!='') ? $current_user->display_name : '') ?>"><span><span>Display Name</span></span></label>
											<div data-active-input-error="data-active-input-error" data-settings-validationerror="setting-page-title"></div>
											<label class="active-input with-prepend-text" for="setting-page-username"><input class="field is-empty usenospace" data-settings-setting-key="account[page_username]" data-settings-setting-value="" data-settings-setting="data-settings-setting" id="setting-page-username" name="account[page_username]" placeholder="<?= $current_user->user_login ?>" type="text" value="<?php echo ((isset($current_user->user_login) && $current_user->user_login!='') ? $current_user->user_login : '') ?>"><span><span>@Username</span></span><div class="prepend-text">yogabody.bio/</div></label>
											<div data-active-input-error="data-active-input-error" data-settings-validationerror="setting-page-username"></div>
										</div>
										...
										<div id="Appearance--Description">
											<div class="sc-gATInX ipmUWe">
												...
												<div class="sc-gfHAkt hQtdpy">
													<textarea id="bioWord_count" placeholder="Enter a bio description to appear on your Yogabody" rows="3" class="sc-hcevGk ekFRyU"><?php echo ((isset($configration->profile_description) && $configration->profile_description!='') ? $configration->profile_description : '') ?></textarea>
													<div class="sc-hxqDJO gAmve"></div>
												</div>
												<div class="sc-koaBLD bHoCON">
													<span class="sc-ha-DqYV fduQSa">
														<span id="display_count" class="sc-kTaSZA iQkmfe">0</span>/
														<span id="word_left" class="sc-kTaSZA iQkmfe">80</span>
													</span>
												</div>
											</div>
										</div>
