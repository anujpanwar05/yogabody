	...
	<div class="sc-bdfBwQ sc-gsTCUz fGhsIW bhdLno">
		<div class="sc-bdfBwQ sc-gsTCUz bcrzgk bhdLno">
			<div class="sc-bdfBwQ LyLIy">
				<div class="sc-bdfBwQ sc-jXktwP keMslg bevupI"></div>
				...
				<div class="sc-bdfBwQ pkAuV">
					<div data-testid="StyledContainer" class="sc-bdfBwQ sc-ctaXAZ kPHwyq bxzBWm">
...
<style>.fGhsIW{-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;position:relative;padding-bottom:0;min-height:100vh;overflow-x:hidden;width:100%;height:100%;}/*!sc*/
	...
	data-styled.g1[id="sc-bdfBwQ"]{content:"fGhsIW,bcrzgk,LyLIy,keMslg,eZNKTD,jgGrsq,llgrqs,pkAuV,kPHwyq,jAmcnV,jSYzUh,"}/*!sc*/
	...
	*,*:before,*:after{box-sizing:inherit;}/*!sc*/
	...
	.bxzBWm:hover{background-color:#fff;border-color:#fff;color:#3a4eff;}/*!sc*/
	data-styled.g93[id="sc-ctaXAZ"]{content:"bxzBWm,"}/*!sc*/
	...
	.bevupI{background:linear-gradient(0deg,#76f3fa,#3a4eff);position:absolute;}/*!sc*/
	data-styled.g114[id="sc-jXktwP"]{content:"bevupI,"}/*!sc*/
	html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,kbd,q,s,samp,small,strike,strong,sub,sup,tt,var,b,u,i,center,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,embed,figure,figcaption,footer,header,hgroup,main,menu,nav,output,ruby,section,summary,time,mark,audio,video{margin:0;padding:0;border:0;font-size:100%;font:inherit;vertical-align:baseline;}/*!sc*/
	article,aside,details,figcaption,figure,footer,header,hgroup,main,menu,nav,section{display:block;}/*!sc*/
	*[hidden]{display:none;}/*!sc*/
	body{line-height:1;}/*!sc*/
