		...
		<div class="sc-bdfBwQ sc-gsTCUz bcrzgk bhdLno">
			<div class="sc-bdfBwQ LyLIy">
				...
				<div class="sc-bdfBwQ pkAuV">
					<div data-testid="StyledContainer" class="sc-bdfBwQ sc-ctaXAZ kzCoZd kZoNvf">
				...
				<div class="sc-bdfBwQ pkAuV">
					<div data-testid="StyledContainer" class="sc-bdfBwQ sc-ctaXAZ kzCoZd kZoNvf">
						<a href="#" id="resume_<?=$link->ID?>" data-id="<?=$link->ID?>" rel="noopener noreferrer" data-testid="LinkButton" display="inline-flex" font-family="inherit" font-weight="inherit" font-size="inherit" height="auto" class="resumeopen LinkButton sc-pFZIQ sc-tYoTV fxPOXp exGbzQ">
							<p class="sc-hKgILt fpenDC"><?php echo stripcslashes($link->title) ?></p>
							<div class="sc-bdfBwQ sc-gsTCUz sc-eGCarw fNlWAC bhdLno XyyJk">
				...
				<div class="sc-bdfBwQ pkAuV">
					<div id="videoContainer_<?=$link->ID?>" data-testid="StyledContainer" class="sc-bdfBwQ sc-ctaXAZ kzCoZd kZoNvf">
				...
				<div class="sc-bdfBwQ pkAuV">
					<div data-testid="StyledContainer" class="sc-bdfBwQ sc-ctaXAZ kzCoZd kZoNvf">
						<a href="#" rel="noopener noreferrer" data-testid="LinkButton" display="inline-flex" font-family="inherit" font-weight="inherit" font-size="inherit" height="auto" class="OpenDigital LinkButton sc-pFZIQ sc-tYoTV fxPOXp exGbzQ">
							<p class="sc-hKgILt fpenDC"><?php echo stripcslashes($link->title) ?></p>
						</a>
					</div>
					<div id="display_digital_<?=$link->ID?>" class="digital-display">
...
<style>.fGhsIW{-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;position:relative;padding-bottom:0;min-height:100vh;overflow-x:hidden;width:100%;height:100%;}/*!sc*/
	...
	*,*:before,*:after{box-sizing:inherit;}/*!sc*/
	...
	.kZoNvf:hover{background-color:transparent;color:#4f7cfe;border-color:#4f7cfe;}/*!sc*/
	data-styled.g93[id="sc-ctaXAZ"]{content:"kZoNvf,"}/*!sc*/
