...
<div class="login" id="wpuf-login-form">
	...
	<form name="lostpasswordform" id="lostpasswordform" action="" method="post">
		...
		<label class="active-input" for="wpuf-user_login">
			<input type="text" class="field is-empty" id="wpuf-user_login" name="user_login" required="required" autocomplete="off">
			<span><span>Username or E-mail</span></span>
		</label>

		<?php do_action( 'lostpassword_form' ); ?>

		<p class="submit">
			<input class="button purple" type="submit" name="wp-submit" id="wp-submit" value="<?php esc_attr_e( 'Get New Password', 'wp-user-frontend' ); ?>" />
