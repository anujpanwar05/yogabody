...
<div class="login" id="wpuf-login-form">
    ...
    <form name="loginform" class="wpuf-login-form" id="loginform" action="<?php echo esc_attr( $action_url ); ?>" method="post">
       <?php /* <p>
		...
		<label class="active-input" for="wpuf-user_login">
			<input type="text" class="field is-empty" id="wpuf-user_login" name="log" value="" required="required" autocomplete="off">
			<span><span>Username</span></span>
		</label>
		<label class="active-input" for="wpuf-user_pass">
			<input type="password" class="field is-empty" id="wpuf-user_pass" name="pwd" required="required" autocomplete="off">
        ...
        <p class="submit">
            <input class="button purple" type="submit" name="wp-submit" id="wp-submit" value="<?php esc_html_e( 'Log In', 'wp-user-frontend' ); ?>" />
