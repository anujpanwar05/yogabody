<?php
/**
 * Template Name: Action link
 * Description: Yogabody action link page.
 */
                    ...
                    <div class="sc-bdfBwQ dOWXkX">
                        ...
                        <div class="sc-bdfBwQ RyEcW">
                            <div class="sc-bdfBwQ sc-gsTCUz ecjOLn bhdLno">
                                <div class="sc-bdfBwQ RyEcW"><img src="https://d1fdloi71mui9q.cloudfront.net/BGQnfqSKQP25zLSXLsIp_1b6ccaa6672a7312083d1f1b1a9b3e86c" alt="Profile Image" data-testid="ProfileImage" filter="none" display="block" class="sc-iBPRYJ QFLjD"/></div>
                                <div class="sc-bdfBwQ cuyGjN">
                                    <h1 class="sc-dlfnbm bCIOzt">ACTION</h1>
                                </div>
                            </div>
                        </div>
                        <div class="sc-bdfBwQ snEmw">
                            <div data-testid="StyledContainer" class="sc-bdfBwQ sc-ctaXAZ HLaPv zDnJ">
                                <a href="<?php echo get_the_permalink(59) ?>" target="_blank" rel="noopener noreferrer" data-testid="LinkButton" display="inline-flex" font-family="inherit" font-weight="inherit" font-size="inherit" height="auto" class="sc-pFZIQ sc-tYoTV fxPOXp exGbzQ">
                                    <p class="sc-hKgILt cdcUDS">DONATE →</p>
                                </a>
                            </div>
                        </div>
                        <div class="sc-bdfBwQ snEmw">
                            <div data-testid="StyledContainer" class="sc-bdfBwQ sc-ctaXAZ HLaPv zDnJ">
                                <a href="<?php echo get_the_permalink(61) ?>" target="_blank" rel="noopener noreferrer" data-testid="LinkButton" display="inline-flex" font-family="inherit" font-weight="inherit" font-size="inherit" height="auto" class="sc-pFZIQ sc-tYoTV fxPOXp exGbzQ">
                                    <p class="sc-hKgILt cdcUDS">EDUCATE →</p>
                                </a>
                            </div>
                        </div>
                        <div class="sc-bdfBwQ snEmw">
                            <div data-testid="StyledContainer" class="sc-bdfBwQ sc-ctaXAZ HLaPv zDnJ">
                                <a href="<?php echo get_the_permalink(63) ?>" target="_blank" rel="noopener noreferrer" data-testid="LinkButton" display="inline-flex" font-family="inherit" font-weight="inherit" font-size="inherit" height="auto" class="sc-pFZIQ sc-tYoTV fxPOXp exGbzQ">
                                    <p class="sc-hKgILt cdcUDS">SHOW UP →</p>
                                </a>
                            </div>
                        </div>
                    </div>
