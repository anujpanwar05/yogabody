			...
			<div class="sc-bdfBwQ LyLIy">
				...
				<div class="sc-bdfBwQ pkAuV">
					<div data-testid="StyledContainer" class="sc-bdfBwQ sc-ctaXAZ kzCoZd kZoNvf">
						<a href="<?= $url ?>" target="_blank" rel="noopener noreferrer" data-testid="LinkButton" display="inline-flex" font-family="inherit" font-weight="inherit" font-size="inherit" height="auto" class="LinkButton sc-pFZIQ sc-tYoTV fxPOXp exGbzQ">
