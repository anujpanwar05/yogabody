	...
	<div class="main-wrap">
		<section class="admin-sidebar sidebar" data-sidebar>
			<div class="sidebar-logo-wrap">
				<a href="https://yogabody.bio/admin">
					<h1>
						Yogabody
						<span class="logo">
		...
		<section class="secondary admin has-toolbar">
			<div id="React--Toolbar" data-linktree-url="https://yogabody.bio/<?= $current_user->user_login ?>">
				<div class="toolbar">
					<div class="toolbar__inner">
						<span class="toolbar__label">My Bio:</span>
						<div class="toolbar__url">
							<a href="https://yogabody.bio/<?= $current_user->user_login ?>" target="_blank" rel="noreferrer">https://yogabody.bio/<?= $current_user->user_login ?></a>
						...
						<div class="sharedisplay" data-popper="data-popper" data-popper-theme="interface" data-popper-visible="false" data-popper-animation="fade" data-popper-reference-hidden="true" data-popper-escaped="true" data-popper-placement="bottom-end" style="position: absolute;top: 45px;right: 10px;">
							<ul>
								<li class="CpyTClipb" tabindex="0">Copy my Yogabody URL</li> 
							<?php /* <li class="showQRcode" tabindex="0">Download my Yogabody QR code</li> */ ?>
							</ul>
						</div>
					</div>
				</div>
				<div class="sc-dUrnRO dEIJXb sc-gyUeRy iBqFyl">
					<div class="sc-httYMd yQeju">
						...
						<div class="sc-fWPcDo cgpajZ">
							...
							<strong>neo</strong>
							<p>https://yogabody.bio/<?= $current_user->user_login ?></p>
